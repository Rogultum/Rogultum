...
## 🚀 About Me
I'm a curious software developer specializing in **React Native,** with a growing expertise in **TypeScript**. I love exploring the intersection of _physics,_ _math_, and _programming_ through my work. I also have experience with languages like **Rust,** **R,** and **Python**.
...
* [Tahmin et - Ben kimim?](https://play.google.com/store/apps/details?id=com.rot.tahminEtBenKimim): A guessing game on App Store and Play Store. Built with React Native, TypeScript.
* [RN-the-best-chat-app](link-to-project): A realtime chat app. Built with React Native, JS.
* [Music-App](link-to-project): A music app that does amazing things. Built with React Native, JS.
* [AndroidDev-Dictionary](link-to-project): An Android dictionary for developers. Built with Kotlin.
* [tailwind_css_website](link-to-project): Practice repository for learning Tailwind CSS.
